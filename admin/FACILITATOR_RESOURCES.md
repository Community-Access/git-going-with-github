...
2. **Async-Friendly** — Students can join sync or async; both are valid
3. **No Pressure** — Fast pace and slow pace are both OK
4. **Narrate Everything** — Say what you're doing before you do it
5. **Celebrate Effort** — Not just finished work; recognition matters
6. **Ask for Help** — "I don't know but let's figure it out together" is OK
7. **Community** — Build an environment where students help each other
