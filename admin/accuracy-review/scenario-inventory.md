...
| SCN-016 | Workflow validation and autograding | Facilitator and learner | [classroom/README.md](../../classroom/README.md), [classroom/grading-guide.md](../../classroom/grading-guide.md), [admin/VALIDATION_AUDIT.md](../VALIDATION_AUDIT.md) | Distinguish Classroom autograding, workflow checks, Aria comments, and manual grading | P0 |
