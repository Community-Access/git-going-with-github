...
| [05](05-vscode-accessibility.md) | **VS Code: Setup & Accessibility Basics** | VS Code interface, github.dev, screen reader mode, keyboard navigation, Accessible Help and Diff | 45 min |
...
| [08](08-culture-etiquette.md) | **Culture and Etiquette** | Open source communication - tone, reviews, inclusive language | 30 min |
| [09](09-labels-milestones-projects.md) | **Labels, Milestones and Projects** | Organize and cross-reference work | 45 min |
| [10](10-notifications.md) | **Notifications and Mentions** | Manage your inbox, @mentions, and subscriptions | 30 min |
...
| **Ch 6** | Try It Right Now | Open a repo in github.dev, enable screen reader mode, explore |
| **Ch 7** | Read a Real PR | Navigate a PR's description, conversation, and diff |
| **Ch 8** | Read a Conflict | Read merge conflict markers and identify both versions |
| **Ch 9** | Rewrite One Comment | Transform a dismissive review comment into constructive feedback |
| **Ch 10** | Label and Link | Add a label to an issue and create a cross-reference |
| **Ch 5** | Tame Your Inbox | Mark a notification as done and configure watch settings |
