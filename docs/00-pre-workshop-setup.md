...
- **VS Code version 1.113 or later** (required for Accessibility Agents in Chapter 19)
...
If you plan to use Accessibility Agents (Chapter 19), advanced accessibility features, or the optional Day 2 extension exercises, ensure you have the following minimum versions:

| Tool | Minimum Version | Why It Matters |
|------|-----------------|---|
| **VS Code** | 1.113 | Accessibility Agents require latest Copilot Chat features |
| **GitHub Copilot** | Latest (auto-updated) | Agents functionality depends on latest extension features |
| **Node.js** | v18.0.0 (if using CLI tools) | Required for npm tools like axe-core, Playwright |
| **Git** | v2.20 | Required for all git operations throughout the workshop |

**To check your versions:**
```bash
code --version         # VS Code version
node --version         # Node.js (if installed)
git --version          # Git version
```

If you don't have Node.js installed, that's fine - it's only needed if you use command-line accessibility tools (optional for Day 2 extension exercises).
