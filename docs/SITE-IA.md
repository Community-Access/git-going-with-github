...
Authority: this doc, together with [EPISODE_MAP.json](EPISODE_MAP.json), governs every URL emitted by the site generator in `c:\code\ggg\generator\`.
...
- **Principles:** [Episode map](EPISODE_MAP.json), [Reorganization master plan](../REORG-PLAN.md)
- **URL map:** [Episode map](EPISODE_MAP.json), [Tooling inventory](TOOLING-INVENTORY.md)
- **Page-level layout:** [Reorganization master plan](../REORG-PLAN.md), [Episode map](EPISODE_MAP.json)
- **Facilitator banners / components / cross-link rendering:** [Episode map](EPISODE_MAP.json), [Reorganization master plan](../REORG-PLAN.md)
