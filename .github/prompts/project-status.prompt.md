...
5. Calculate per-column metrics:
...
7. Show sprint/iteration progress if applicable:
   - Completion percentage
   - Burn-down status (on track / behind / ahead)
   - Days remaining
8. Present in chat with option to generate a saved document.
