...
7. Confirm: _"PR review documents saved to `{md-path}` and `{html-path}`. Say 'comment on L42' to leave feedback on any line. Open the docs, check off items, and add your notes."_
